while True :
    ...
    print("4. Pembagian")
    print("5. Exit")
    program = int(input("Pilih program yang ingin dimasukkan :"))
    if program == 1:
        ...
        print("Hasil nilai1 %d * nilai2 %d adalah : %d"%(nilai1,nilai2,perkalian))
    elif program == 4 :
        nilai1 = int(input("Masukkan nilai 1 :"))
        nilai2 = int(input("Masukkan nilai 2 :"))
        ...
        print("Terimakasih telah menggunakan kalkulator M Adi Syahputra")
        break
    else :
